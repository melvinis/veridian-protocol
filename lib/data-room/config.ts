...
export const DATA_ROOM_FOLDERS: DataRoomFolder[] = [
  ...
  },
  {
    ...
    documents: [
      ...
      {
        id: "business-plan-rak-innovation-city",
        name: "Business Plan — RAK Innovation City Submission",
        type: "DOCX",
        description: "Business plan submitted to the RAK Innovation City Authority in connection with the Company's incorporation",
        lastUpdated: "June 2026",
        available: true,
        storagePath: "Corporate Strategy/Veridian_Protocol_FZCO_Business_Plan_2026_V2.1_RAK_Innovation_City.docx",
      },
      {
        id: "business-plan-banking",
        name: "Business Plan — Bank Account Opening",
        type: "DOCX",
        description: "Bank-ready business plan for corporate account opening, with KYC information summary annex",
        lastUpdated: "June 2026",
        available: true,
        storagePath: "Corporate Strategy/Veridian_Protocol_Bank_Account_Business_Plan_2026.docx",
      },
      {
        id: "vision-bank-account-opening-information",
        name: "Vision Bank — Account Opening Information Request (Completed)",
        type: "DOCX",
        description: "Vision Bank's customer information request reproduced and filled with the Company's responses",
        lastUpdated: "June 2026",
        available: true,
        storagePath: "Corporate Strategy/Veridian_Protocol_VisionBank_Account_Opening_Information.docx",
      },
    ],
  },
  {
